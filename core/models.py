...
class FishProduct(models.Model):
    ...
    fisherman = models.ForeignKey(User, on_delete=models.CASCADE, related_name='products')
    species = models.ForeignKey(FishSpecies, on_delete=models.CASCADE, related_name='products')
